import { checks, getSourcePackageInfo } from './checks.js';
 ...
 * @param {Array} params.files - File list from npm pack (each has .path)
...
export function runQualityChecks({
  ...
  const context = { packageJson, readme, lpmConfig, files, unpackedSize };
