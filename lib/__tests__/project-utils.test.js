...
describe('project-utils.js – getDefaultPath()', () => {
	...
	it('returns components/<name> for next-app when components/ exists', () => {
		createTmpProject({ 'components/.gitkeep': '' })
		expect(getDefaultPath('next-app', 'button')).toBe('components/button')
	})

	it('returns src/components/<name> for next-app when no components/ dir', () => {
		createTmpProject({})
		expect(getDefaultPath('next-app', 'button')).toBe(
			'src/components/button',
		)
	})

	it('returns src/components/<name> for vite', () => {
		createTmpProject({})
		expect(getDefaultPath('vite', 'card')).toBe('src/components/card')
	})

	it('returns src/components/<name> for remix', () => {
		createTmpProject({})
		expect(getDefaultPath('remix', 'dialog')).toBe(
			'src/components/dialog',
		)
	})

	it('returns src/components/<name> for unknown framework', () => {
		createTmpProject({})
		expect(getDefaultPath('unknown', 'widget')).toBe(
