...
describe("xcf-multi-slice", () => {
	it("returns 18 points for 4+ unique platforms", () => {
	...
	it("returns 14 points for 3 unique platforms", () => {
		const result = runCheck("xcf-multi-slice", {
			xcframeworkMeta: {
				slices: [
					{ platform: "ios", architectures: ["arm64"] },
...
describe("XCFramework check registry", () => {
	it("has 19 checks total", () => {
		expect(xcframeworkChecks).toHaveLength(19)
	})
	...
	it("has code category = 45 points", () => {
