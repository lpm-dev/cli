...
describe('runQualityChecks', () => {
	...
	it('returns checks array with all 26 checks', () => {
		const result = runQualityChecks(makeContext())
		expect(result.checks).toHaveLength(26)
	})
...
describe('runQualityChecks with ecosystem=swift', () => {
	it('returns 23 checks for Swift ecosystem', () => {
...
describe('runQualityChecks with ecosystem=xcframework', () => {
	it('returns 19 checks for XCFramework ecosystem', () => {
		...
		const result = runQualityChecks(
			makeXCFrameworkContext({
				...
				files: [
					...
					{ path: 'MyLib.xcframework/ios-arm64/MyLib.framework/MyLib', size: 500000 },
					{ path: 'MyLib.xcframework/ios-arm64_x86_64-simulator/MyLib.framework/MyLib', size: 800000 },
					{ path: 'MyLib.xcframework/macos-arm64_x86_64/MyLib.framework/MyLib', size: 600000 },
					{ path: 'CHANGELOG.md', size: 500 },
					{ path: 'LICENSE', size: 1000 },
					{ path: '.github/workflows/ci.yml', size: 800 },
				],
