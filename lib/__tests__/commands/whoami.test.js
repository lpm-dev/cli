...
describe("whoami command", () => {
	...
	it("displays plan tier and usage", async () => {
		...
		expect(log.success).toHaveBeenCalledWith(
			expect.stringContaining("Pool: Active"),
		)
		expect(log.info).toHaveBeenCalledWith(
			expect.stringContaining("@lpm.dev/alice.*"),
		)
		expect(log.info).toHaveBeenCalledWith(
			expect.stringContaining("@lpm.dev/acme.*"),
		)
	})
	...
	it("warns when over limit", async () => {
		...
		expect(log.error).toHaveBeenCalledWith(
			expect.stringContaining("OVER LIMIT"),
		)
		expect(log.warn).toHaveBeenCalledWith(
			expect.stringContaining("over its plan limits"),
		)
	})
